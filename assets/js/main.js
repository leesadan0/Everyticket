...
(function () {
  ...
  const EMO = ['', '', '', ' ㅠㅠ', ' ㅎㅎ', ' 🙏', ' 👍', ' ✨', ' 🥹', ' 😭', ' 🔥'];
  const DELTA = [
    '아직 선예매 전인데 선착순으로 예약 걸어뒀어요. 오픈 때 잡아주신대요.',
    '인기 많아서 혼자 선예매하면 떨어질 것 같아서 댈티 접수했습니다.',
    '오픈도 선예매도 아직인데 미리 등록해 두니까 마음이 놓여요.',
    '직접 넣으면 실패 확률 올라간다고 해서 선착순 예약했습니다.',
    '선착순으로 받아주셔서 오픈 때 좋은 자리 잡아준다고 하심.',
    '뒤에 등록해도 만족하는 자리 나온다고 해서 바로 맡겼어요.',
    '팬클럽 선예매라 혼자 못 넣을 것 같아서 업체에 걸어뒀습니다.',
    '선예매 전에 접수만 해두면 된다길래 바로 신청했어요.',
    '희망 회차만 적어서 보냈더니 선착순 등록해 주심.',
    '인기 콘서트라 선착순 대행으로 예약해 뒀습니다.',
    '오픈 전인데 선착순 걸어두면 오픈 날 대신 잡아주신대요.',
    '선예매 아직 안 열렸고 지금은 예약만 해 둔 상태예요.',
    '혼자 연습하다 포기하고 선착순 접수부터 걸어뒀어요.',
    '선예매 시간이 평일이라 미리 대행에 등록해 뒀습니다.',
    '인기 많아서 선착순 뒤로 가도 자리 나온다고 하셔서 맡겼어요.',
    '아직 티켓팅 전인데 접수해 두니까 당일엔 신경 안 써도 될 듯요.',
    '직접 하면 터질 것 같아서 선착순으로 예약 걸었습니다.',
    '선착순 인원 다 잡아준다고 해서 믿음 가고 접수했어요.',
    '오픈 전에 카톡 한 통으로 선착순 등록 끝났습니다.',
    '멤버십 선예매 회차로 예약해 달라고 했고 바로 받아주심.',
    '친구랑 갈 회차만 적어두고 선착순 걸어뒀어요.',
    '선예매 창 뜨기 전에 미리 업체에 등록해 두는 시스템이네요.',
    '인기 많아서 선착순이 중요하다고 해서 바로 걸었습니다.',
    '아직 오픈 전이라 결과는 없고 예약만 해 둔 거예요.',
    '희망 날짜 두 개 적어줬더니 선착순으로 받아주셨어요.',
    '댈티 처음인데 선예매 전에 접수만 하면 된대요.',
    '혼자 넣다 실패할까 봐 선착순 예약부터 했습니다.',
    '선착순 뒤로 갈수록 자리는 조금 밀린다는데 다 잡는대요.',
    '오픈 전날에도 선착순 받아주셔서 감사합니다.',
    '선예매 대상자 인증만 알려주시고 예약 걸어주심.',
    '인기 공연이라 직접 하면 확률 낮아서 여기로 등록했어요.',
    '아직 선예매 전이고 선착순 대기만 걸어둔 상태입니다.',
    '오픈 때 좋은 자리 잡아준다고 해서 미리 접수했습니다.',
    '선착순 대행이라 설명 길지 않고 바로 등록됐어요.',
    '원하는 날만 말하고 자리는 오픈 때 잡아달라고 부탁드렸습니다.',
    '선예매 아직인데 접수해 두니까 스트레스가 없어요.',
    '인기 많아서 선착순 걸어두고 오픈만 기다리면 된대요.',
    '직접 티켓팅하면 실패할 것 같아서 업체에 예약했습니다.',
    '선착순 등록만 해두면 오픈 날 대신 넣어주신다고 하심.',
    '오픈도 안 했는데 미리 받아주셔서 편했어요.',
    '회차 고민됐는데 선착순으로 받아두시고 오픈 때 맞춰주신대요.',
    '선예매 전에 선착순 걸어두는 거라 이해가 빨랐어요.',
    '인기 콘서트라 선착순 인원 다 자리 나온다고 해서 맡겼습니다.',
    '아직 결과 없고 예약만 했는데도 답장이 빨라서 좋았어요.',
    '오픈 아침 회의라서 미리 선착순 등록해 뒀습니다.',
    '혼자 선예매 준비하다 포기하고 댈티 접수했어요.',
    '선착순이라 빨리 걸어달라고 했더니 바로 받아주셨어요.',
    '티켓팅 전인데 접수만 해두면 된다길래 그대로 따라갔습니다.',
    '인기 많아서 선착순 뒤로 가도 만족하는 자리 나온다고 하심.',
    '선예매 아직 안 해서 지금은 예약 등록만 해 둔 후기입니다.'
  ];
  const MOVE = [
  ...
  const talkLine = (soon, talk, rng) => {
    ...
    const delta = [
      n && n + ' 보려고 선착순 예약해 뒀어요.',
      n && n + ' 직관 가려고 댈티 접수했습니다.',
      f && f + ' 몰릴 것 같아서 혼자 안 넣고 선착순 걸어뒀어요.',
      n && '오픈 전에 ' + n + ' 선착순 등록해 뒀습니다.',
      f && f + '들 많을 것 같아서 선예매 전에 접수했어요.',
      n && n + ' 선예매 아직인데 미리 받아주심.'
    ].filter(Boolean);
    const move = [
  ...
  const kakaoId = (kakaoModal && kakaoModal.dataset.kakaoId) || 'Eeveryticket';
